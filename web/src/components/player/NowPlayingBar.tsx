...
export function NowPlayingBar() {
  ...
  if (!track) {
    return (
      <div className="hidden h-14 min-w-0 flex-1 items-center justify-center rounded-xl border border-white/10 bg-white/[0.04] lg:flex">
  ...
  return (
    <div className="hidden h-14 min-w-0 flex-1 items-center gap-3 rounded-xl border border-fuchsia-300/15 bg-fuchsia-400/[0.05] px-2 lg:flex">
      <button
        type="button"
