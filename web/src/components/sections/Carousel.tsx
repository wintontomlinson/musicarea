  ...
  return (
    <section>
      <div className="mb-4 flex items-end gap-3">
        ...
        {row.showAll && <Link href={row.showAll} className="tint-chip ml-auto shrink-0 hover:bg-accent/20 hover:text-white">See all <Icon name="chevronRight" size={13} /></Link>}
      </div>
